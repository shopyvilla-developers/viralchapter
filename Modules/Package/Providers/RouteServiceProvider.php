...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Modules\Package\Http\Controllers';
    ...
    public function boot()
    {
       ...
       //$this->registerPackageRoute();
    }

    // private function registerPackageRoute()
    // {
        
    //     $this->app->booted(function () {
    //         Route::get('{slug}', '\Modules\Package\Http\Controllers\PackageController@show')
