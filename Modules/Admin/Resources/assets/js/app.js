...
$(function () {
    ...
    var o = $.CloudCMS.options;

    // Set up the object
    _init();

    // Activate layout
    $.CloudCMS.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.CloudCMS.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.CloudCMS.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the CloudCMS Object -
   ---------------------------------- */
function _init() {
    ...
    $.CloudCMS.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.CloudCMS.options.screenSizes;
    ...
    // Tree
    $.CloudCMS.tree = function (menu) {
        var animationSpeed = $.CloudCMS.options.animationSpeed;
