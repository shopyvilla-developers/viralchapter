...
namespace CloudCMS\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use CloudCMS\Scaffold\Module\Generators\FilesGenerator;
use CloudCMS\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \CloudCMS\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \CloudCMS\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \CloudCMS\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \CloudCMS\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The CloudCMS {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The CloudCMS {$moduleName} Module.\"," . PHP_EOL;
